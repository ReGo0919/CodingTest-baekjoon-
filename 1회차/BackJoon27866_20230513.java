...
public class BackJoon27866_20230513 {
     ...
     */
       ...
       BufferedReader subbr = new BufferedReader(new InputStreamReader(System.in));
       int i = Integer.parseInt(subbr.readLine());
        for(int j = 0 ; j < s.length ; j++){
        if (i == j+1) System.out.println(s[j]);
        }
    }
}
